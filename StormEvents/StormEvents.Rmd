---
title: "Weather Events - Cost and Fatalities"
author: "Uriel Tallon"
...
```{r groupevents, fig.height = 6, fig.width = 10}
...
```{r mapnevents, fig.height = 8, fig.width = 10}
...
```{r mapfevents, fig.height = 8, fig.width = 10}
...
```{r pointsdrift, results = "hide", message = FALSE}
...
```{r maphevents, fig.height = 8, fig.width = 10}
...
```{r mapcevents, fig.height = 8, fig.width = 10}
...
```{r mappevents, fig.height = 8, fig.width = 10}
